...
categories: [java]
tags: [java, thread]
description: Java多线程所有锁详解笔记
keywords: java, thread, lock
dashang: true
topmost: false
mermaid: true
...
![img](/images/java/java-lock-1.png)
...
![img](/images/java/java-lock-2.png)
...
![img](/images/java/java-lock-4.png)
...
![img](/images/java/java-lock-6.png)
...
![img](/images/java/java-lock-12.png)

但如果是非可重入锁的话，此时管理员只允许锁和同一个人的一个水桶绑定。第一个水桶和锁绑定打完水之后并不会释放锁，导致第二个水桶不能和锁绑定也无法打水。当前线程出现死锁，整个等待队列中的所有线程都无法被唤醒。

![img](/images/java/java-lock-13.png)
...
![img](/images/java/java-lock-14.png)
...
![img](/images/java/java-lock-15.png)
