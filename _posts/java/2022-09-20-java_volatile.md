---
layout: post
title: Java多线程volatile笔记
categories: [java]
tags: [java, thread]
description: Java多线程开发比较容易产生误解的修饰符 volatile
...
![img](https://pdai.tech/_images/thread/java-thread-x-key-volatile-1.png)
...
![img](https://pdai.tech/_images/thread/java-thread-x-key-volatile-3.png)

![img](https://pdai.tech/_images/thread/java-thread-x-key-volatile-4.png)
