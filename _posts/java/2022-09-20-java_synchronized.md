---
layout: post
title: Java多线程synchronized笔记
categories: [java]
tags: [java, thread]
description: java语言中最常用的同步方法, synchronize.
keywords: java, thread, lock, synchronized
dashang: true
topmost: false
mermaid: true
...
![img](/images/java/java-thread-x-key-schronized-x1.png)
...
![img](/images/java/java-thread-x-key-schronized-2.png)
...
![img](/images/java/java-thread-x-key-schronized-3.png)
...
![img](/images/java/java-thread-x-key-schronized-4.png)
...
![img](/images/java/java-thread-x-key-schronized-5.png)
...
![img](/images/java/java-thread-x-key-schronized-6.png)
...
![img](/images/java/java-thread-x-key-schronized-7.png)
...
![img](/images/java/java-thread-x-key-schronized-8.png)
...
![img](/images/java/java-thread-x-key-schronized-9.png)
