---
layout: post
title: Android系统服务之ServiceManager注册Native层的服务的过程
categories: [android]
description: 讲解如何向ServiceManager注册Native层的服务的过程
keywords: android, ServiceManager
dashang: true
topmost: false
...
![add_media_player_service](/images/android/add_media_player_service.png)
...
![addService](/images/android/addService.jpg)
...
![media_player_service_ipc](/images/android/media_player_service_ipc.png)
